...
parser.add_argument("-h", help="Associates headers to HTTP Request with the format 'key:value'.", metavar="k:v", action='append')
...
if args.get and (args.d or args.f):
    ...
    contents = postStuff.headers if "v" in args else '\n' + postStuff.text
